...
public class PureCacheU {
	...
	public PureNode find(PureNode a, PureNode b) {
		...
		if (a.hashCode() < b.hashCode()) {
			...
			System.arraycopy(b.bigHash, 0, checkBlock2, 0, HALFBLOCK);
			System.arraycopy(a.bigHash, 0, checkBlock2, HALFBLOCK, HALFBLOCK);
		}
	...
	public void insert(PureNode a, PureNode b, PureNode result) {
		...
		if (a.hashCode() < b.hashCode()) {
			...
			System.arraycopy(b.bigHash, 0, opBlocks, opIndex, HALFBLOCK);
			System.arraycopy(a.bigHash, 0, opBlocks, opIndex + HALFBLOCK, HALFBLOCK);
		}
